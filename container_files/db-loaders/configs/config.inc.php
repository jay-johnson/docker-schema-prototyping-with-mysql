 ...
 * cookie
 */
$cfg['blowfish_secret'] = '28573169991289628594'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['verbose']       = 'CHANGE_TO_DBNAME';
$cfg['Servers'][$i]['host']          = '127.0.0.1';         // MySQL hostname or IP address
$cfg['Servers'][$i]['port']          = 'CHANGE_TO_DBPORT';  // MySQL port - leave blank for default port
$cfg['Servers'][$i]['user']          = 'CHANGE_TO_DBUSER';
$cfg['Servers'][$i]['password']      = 'CHANGE_TO_DBPASS';
